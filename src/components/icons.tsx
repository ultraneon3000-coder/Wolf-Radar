// Kleine, abhängigkeitsfreie Icon-Sammlung (Strich-Icons, 24x24, currentColor).
// Bewusst handgeschrieben statt einer Icon-Bibliothek — nur eine Handvoll Icons nötig.
